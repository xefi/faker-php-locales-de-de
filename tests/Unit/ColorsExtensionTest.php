...
final class ColorsExtensionTest extends \Xefi\Faker\DeDe\Tests\Unit\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $colorsExtension = new \Xefi\Faker\DeDe\Extensions\ColorsExtension(new \Random\Randomizer());
