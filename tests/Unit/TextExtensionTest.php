...
final class TextExtensionTest extends \Xefi\Faker\DeDe\Tests\Unit\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $textExtension = new \Xefi\Faker\DeDe\Extensions\TextExtension(new \Random\Randomizer());
